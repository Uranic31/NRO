...
#pragma omp critical
    ...
    std::cout << "Cas paralelizacije: " << time_duration_omp.count() << " seconds" << std::endl;
    ...
    //izpis posameznih temperatur
    //for (int i = 0; i < n; i++) {
    //    std::cout << "element vektorja = " << T[i] << endl;
    //}
